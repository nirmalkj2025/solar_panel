...
import { Sun, CloudRain, Wind, ThermometerSun, Droplet,CheckCircle, AlertCircle, Clock, Heart } from 'lucide-react';
    ...
    <Grid item xs={12} md={5}>
      <StatCard elevation={3} sx={{ bgcolor: '#1c1c1e', color: '#fff', p: 2 }}>
        ...
        <Typography variant="caption" color="gray" mb={2}>
          Tracks energy used locally vs exported to the grid. Helps optimize for higher self-consumption and storage decisions.
        </Typography>
...
const PerformanceRatioCard = ({ value = 0.825 }) => {
  return (
    ...
    <StatCard elevation={3} sx={{ bgcolor: '#1c1c1e', color: '#fff' }}>
      ...
      <GaugeChart id="pr-gauge" nrOfLevels={20} percent={value} colors={["#ff4d4d", "#00e676"]} arcWidth={0.2} textColor="white" />
      </Box>
    </StatCard>
    </Grid>
  );
          ...
          <Box height={200}>
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={chartData}  margin={{ left: -40 }}>
                ...
                <Tooltip contentStyle={{ backgroundColor: '#fff', borderRadius: 4, fontSize: 12 }} labelStyle={{ fontWeight: 600 }} />
                <Line
                  type="monotone"
                  dataKey="yield"
                  stroke="#007aff"
      ...
      <StatCard elevation={3} sx={{ bgcolor: '#1c1c1e', color: '#fff' }}>
        ...
        <Box display="flex" alignItems="center" gap={1} mb={2}>
          ...
          <Typography variant="caption" sx={{ color: '#b2fab4' }}>
            AI has auto-corrected minor issues by adjusting operational parameters and rebooting modules remotely.
          </Typography>
        </Box>
...
<Grid item xs={12}>
<Grid container spacing={2}>
<BatteryStorageCard/> <EnergyExportCard /> <WeatherForecastImpactCard />
</Grid>
</Grid>
